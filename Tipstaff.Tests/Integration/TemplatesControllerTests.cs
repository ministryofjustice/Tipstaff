...
//            templateIndex = _guidGenerator.GenerateTimeBasedGuid().ToString();
//            var presenter = new PresenterTemplate();
//            _sub = new TemplatesController(_templateRepository, _s3Repository, _guidGenerator);
//        }
