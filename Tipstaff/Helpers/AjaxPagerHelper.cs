...
namespace Tipstaff.Extensions
{
    public static class PagerHelper
    {
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, object htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, IDictionary<string, object> htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, pagerOptions, null);
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, string routeName, RouteValueDictionary routeValues)
        {
            if (pagedList == null)
                return Pager(helper, pagerOptions, null);
            return Pager(helper, pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, pagerOptions, routeName, routeValues, null);
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, string routeName, object routeValues, object htmlAttributes)
        {
            if (pagedList == null)
                return Pager(helper, pagerOptions, new RouteValueDictionary(htmlAttributes));
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, PagerOptions pagerOptions, string routeName,
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, string routeName, object routeValues, object htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, xPagedList<T> pagedList, string routeName, RouteValueDictionary routeValues,
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string routeName, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
                return AjaxPager(html, null, null);
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions, object htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string routeName, object routeValues, PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
                return AjaxPager(html, pagerOptions, null);
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string routeName, object routeValues,
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string routeName, RouteValueDictionary routeValues,
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string actionName, string controllerName,
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, xPagedList<T> pagedList, string actionName, string controllerName,
            PagerOptions pagerOptions, RouteValueDictionary routeValues, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
                return AjaxPager(html, pagerOptions, null);
            return AjaxPager(html, pagedList.TotalPageCount, pagedList.CurrentPageIndex, actionName, controllerName, null, pagerOptions, routeValues, ajaxOptions, null);
        }
        #endregion
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, AjaxOptions ajaxOptions)
        {
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions, object htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions, IDictionary<string, object> htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, string routeName, object routeValues, AjaxOptions ajaxOptions, object htmlAttributes)
        {
            if (pagedList == null)
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, string routeName, RouteValueDictionary routeValues,
        ...
        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, xPagedList<T> pagedList, string routeName, object routeValues, PagerOptions pagerOptions,
        ...
        public class PagerBuilder
        {
            ...
            public MvcHtmlString RenderPager()
            {
                ...
                tc.InnerHtml = sb.ToString();
                tb.InnerHtml = tc.ToString();
                ...
                if (_pagerOptions.UseJqueryAjax)
                {
                    ...
                    return string.IsNullOrEmpty(url)
                               ...
                               : String.Format(CultureInfo.InvariantCulture,
                                               "<li class=\"PageSelectable\"><a href=\"{0}\" onclick=\"{1}\">{2}</a></li>",
                                               url, scriptBuilder, item.Text);
                }
                return "<li class=\"PageSelectable\"><a href=\"" + url +
                       "\" onclick=\"window.open(this.attributes.getNamedItem('href').value,'_self')\"></a></li>";
            }
